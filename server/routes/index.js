...
router.post('/member', controllers.member.post)
router.get('/member', controllers.member.get)
router.post('/health', controllers.health.post)
router.get('/health', controllers.health.get)
router.post('/smoke', controllers.smoke.post)
router.get('/smoke', controllers.smoke.get)
router.post('/ldlc', controllers.ldlc.post)
router.get('/ldlc', controllers.ldlc.get)
router.post('/hdlc', controllers.hdlc.post)
router.get('/hdlc', controllers.hdlc.get)
router.post('/disease', controllers.disease.post)
